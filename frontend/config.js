...
window.APP_CONFIG = {
  ...
  // Shared "guest" account — anyone signs in with these credentials.
  // The account is auto-created on first use (requires email confirmation OFF).
  GUEST_EMAIL: "guest@ielts-ai.app",
  GUEST_PASSWORD: "pharmacy2026",
};
